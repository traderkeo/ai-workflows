...
const AIAgentNodeV6Component: React.FC<NodeProps> = (props) => {
...
export const AIAgentNodeV6 = React.memo(AIAgentNodeV6Component);
AIAgentNodeV6.displayName = 'AIAgentNodeV6';
